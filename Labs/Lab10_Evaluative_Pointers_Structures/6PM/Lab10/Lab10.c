...
/**
 * @brief Prints the character that occurs the maximum number of times in the favourite quote of the employee with the higher salary.
 * If there are more than 1 characters occuring the most, then print the character that has its first occurence at the lower index.
 ...
 * Example 1:
 *    s= "BITS_Pilani."
 *    Prints: The character occuring the maximum time is: i
 * 
 * Example 2:
 *    s= "Its_Magic."
 *    Prints: The character occuring the maximum time is: I
 ...
 *    Prints: The character occuring the maximum time is: i
*/
void max_occurence(char* s)
{
  char c;
  
  //TODO

  printf("The character occuring the maximum time is: %c\n", c);
}
...
*/
  ...
  printf("\t3. Find the character in the quote that occurs the maximum number of times.\n\n");
