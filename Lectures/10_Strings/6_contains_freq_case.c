...
The search should happen ignoring the case.
*/
...
int main()
{
    ...
    scanf("%s", key);
    //printf("%s appeared in %s %d times ignoring the case.\n", key, str, count(str, key));
    printf("%s appeared in %s ", key, str);
    printf("%d times ignoring the case.\n", count(str, key));
    return 0;
}